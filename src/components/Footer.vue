        ...
        <div class="col-lg-4">
          <div class="ei-footer-widget appeight-headline ul-li-block">
            ...
            <ul>
              ...
              <li><a href="point-system.html">Points System</a></li>
        ...
        <div class="col-lg-4">
          <div class="ei-footer-widget appeight-headline  ul-li-block">
            ...
            <h4>
              ...
              Call Us: +91 9223503509
              <span></span>
            </h4>
            <h4>
              <i class="fas fa-map-marker-alt"></i>
              502, Tulsi Tower,T.P.S. Road
              <span>Borivali West,Mumbai-92</span>
            </h4>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="ei-copyright-text">
                <p>
                  © 2021
                  <a href="https://isparxinfotech.com/">ISPARX INFOTECH LLP</a>
                </p>
              </div>
            </div>
            <div class="col-md-8">
              <div class="ei-copyright-menu">
                <a href="point-system.html">Help</a>
